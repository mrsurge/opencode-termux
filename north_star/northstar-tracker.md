...
- Maintenance baseline: the active app-server branch is rebased onto upstream `v1.17.11`; the app-server patch stack was replayed with quilt.
- Next upstream rebase rule: keep using quilt as the actual patch apply path and preserve the app-server branch as a carried patch stack over upstream tags.
